        ...
        <div class="wrap">
            ...
            <div class="cont span_2_of_3">
                        ...
                        <li>
                            <a href="optionallink.html">
                                <img class="etalage_thumb_image"
                                    src="public/images/tabas/<?php echo $fetch['product_image']; ?>" height="42" width="42"/>
                                <img class="etalage_source_image"
                                    src="public/images/tabas/<?php echo $fetch['product_image']; ?>" height="42" width="42"/>
                            </a>
                        </li>
                        <!-- <li>    
                            <img class="etalage_thumb_image" src="public/images/t2.jpg" />
                            <img class="etalage_source_image" src="public/images/t2.jpg" />
                        </li>
                        <li>
                            <img class="etalage_thumb_image" src="public/images/t3.jpg" />
                            <img class="etalage_source_image" src="public/images/t3.jpg" />
                        </li>
                        <li>
                            <img class="etalage_thumb_image" src="public/images/t4.jpg" />
                            <img class="etalage_source_image" src="public/images/t4.jpg" />
                        </li>
                        <li>
                            <img class="etalage_thumb_image" src="public/images/t5.jpg" />
                            <img class="etalage_source_image" src="public/images/t5.jpg" />
                        </li>
                        <li>
                            <img class="etalage_thumb_image" src="public/images/t6.jpg" />
                            <img class="etalage_source_image" src="public/images/t6.jpg" />
                        </li>
                        <li>
                            <img class="etalage_thumb_image" src="public/images/t1.jpg" />
                            <img class="etalage_source_image" src="public/images/t1.jpg" />
                        </li> -->
                    </ul>
                ...
                <div class="cont1 span_2_of_a1">
                    <h3 class="m_3"><?php echo $fetch['product_name']; ?></h3>
                    ...
                    <div class="btn_form">
                        <a href="checkout.php?id=<?php echo $fetch['product_id']; ?>&action=add"><button class="grey" name="register_login">Submit</button></a>
                    </div>
                    <br>
                    <ul class="add-to-links">
                        <li><img src="public/images/wish.png" alt="" /><a href="#">Add to wishlist</a></li>
                    </ul>
                    <p class="m_desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        incididunt
                ...
                <ul id="flexiselDemo3">
                    <li><img src="public/images/pic11.jpg" />
                        <div class="grid-flex"><a href="#">Bloch</a>
                            <p>Rs 850</p>
                        </div>
                    </li>
                    <li><img src="public/images/pic10.jpg" />
                        <div class="grid-flex"><a href="#">Capzio</a>
                            <p>Rs 850</p>
                        </div>
                    </li>
                    <li><img src="public/images/pic9.jpg" />
                        <div class="grid-flex"><a href="#">Zumba</a>
                            <p>Rs 850</p>
                        </div>
                    </li>
                    <li><img src="public/images/pic8.jpg" />
                        <div class="grid-flex"><a href="#">Bloch</a>
                            <p>Rs 850</p>
                        </div>
                    </li>
                    <li><img src="public/images/pic7.jpg" />
                        <div class="grid-flex"><a href="#">Capzio</a>
                            <p>Rs 850</p>
                        </div>
                    </li>
